        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            ...
            <p className="text-muted-foreground text-base leading-relaxed mb-8">
              Cuéntanos sobre tu organización y un consultor se pondrá en contacto contigo en menos de 24 horas.
            </p>

            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-accent" />
                <span className="text-foreground">+57 317 680 0661</span>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-accent" />
                <span className="text-foreground">info@questjuntos.com</span>
              </div>
              <div className="flex items-center gap-3">
                <MapPin className="w-5 h-5 text-accent" />
                <span className="text-foreground">Barranquilla, Colombia</span>
              </div>
            </div>
